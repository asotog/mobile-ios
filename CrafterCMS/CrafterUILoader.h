...
@class CrafterHomeViewController;
@class CrafterGalleryViewController;
@class CrafterConnectViewController;

@interface CrafterUILoader : NSObject

+ (CrafterUILoader *)sharedInstance;

- (void)loadGlobalUI:(UITabBarController *)windowRootViewController;
